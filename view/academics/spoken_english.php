...
<?php breadcrum("Spoken English (Basic & Advanced)");
?>
<!--==============================
Event Area  
==============================-->
                ...
                <div class="course-single">
                    ...
                    <div class="course-single-bottom">
                        <ul class="nav course-tab" id="courseTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="curriculam-tab" data-bs-toggle="tab" href="#curriculam" role="tab" aria-controls="curriculam" aria-selected="false"><i class="fa-regular fa-book"></i>Teaching</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="productTabContent">
                            <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                <div class="course-description">
                                    ...
                                    <p>Designed to improve fluency, pronunciation, and communication skills in English.</p>

                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="checklist mb-4">
                                                <ul>
                                                    <li><strong>Basic And Advance Duration:</strong>2.5 months</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <h5 class="h5 mt-40">Study Plan</h5>
                                        <div class="col-lg-12">
                                            <div class="checklist">
                                                <ul>
                                                    <li>Basic, Intermediate, and Advanced Levels.</li>
                                                    <li>Focus on vocabulary building, grammar, and public speaking.</li>
                                                </ul>
                                            </div>
                                        </div>

                                        <h5 class="h5 mt-40">Government-Approved Books</h5>
                                        <div class="col-lg-12">
                                            <div class="checklist">
                                                <ul>
                                                    <li>NCERT English Textbooks.</li>
                                                    <li>Cambridge English Learning Material.</li>
                                                    <li>British Council Recommended Books.</li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                <div class="course-curriculam">
                                        <h5 class="h5 mt-40">Teaching</h5>
                                        <div class="col-lg-12">
                                            <div class="checklist">
                                                <ul>
                                                    <li>Interactive sessions with real-life conversation practice.</li>
                                                    <li>Audio-visual learning materials.</li>
                                                    <li>Regular speaking and listening exercises.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <h5 class="h5 mt-40">Preparation</h5>
                                        <div class="col-lg-12">
                                            <div class="checklist">
                                                <ul>
                                                    <li>Daily practice of spoken English.</li>
                                                    <li>Watching English movies and reading newspapers.</li>
                                                    <li>Engaging in conversations in English.</li>
                                                </ul>
                                            </div>
                                        </div>
